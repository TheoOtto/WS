...
@section('content')
    <div class="card mt-5">
        ...
        <div class="card-body">
            <form action="{{ url('disciplina/' . $disciplinas->id) }}" method="post">
                <input type="hidden" name="id" id="id" value="{{ $disciplinas->id }}">
                {!! csrf_field() !!}
                @method('PATCH')
                <div class="mb-3">
                    ...
                    <input
                        ...
                        value="{{ $disciplinas->disciplina_nome }}"
                        required
                    />
                </div>
                <div class="mb-3">
                    ...
                    <select
                        ...
                        required
                    >
                        <option selected>Turma Atual : {{ $disciplinas->disciplina_turma }}</option>
